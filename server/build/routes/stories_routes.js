...
class StoriesRoutes {
    ...
    routes() {
        this.router.get('/', stories_controller_1.default.get.bind(stories_controller_1.default));
        // this.router.get('/:id', stories.geById);
        this.router.post('/', stories_controller_1.default.create.bind(stories_controller_1.default));
    }
}
